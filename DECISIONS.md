...
6. **Intent is projected, never copied into parallel authoring fields.** Pure
   functions in `core/intent.py` derive provider prompt sections, v3 picture
   payload, v2 positioned expectations, and the director view from ShotSpec.
