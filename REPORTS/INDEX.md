...
| Report | Record |
|---|---|
| `continuation/R9.md` | Local returned-video preflight and bounded real full decode |
...
| `research-dogfood-r2/RESEARCH_2026-09-06.md` | 2026-09-06 official-source research: external agents, video controls, model retirement, and concrete R2 scope |
...
| `product-polish-r1/WAVE15_FINAL_RELEASE_READINESS.md` | Product Polish R1 final local wave: one global read-only F1 Help & Support surface, explicit local-data/privacy boundary, contract-governed zero-cost RC orchestration, offline wheel install smoke and final handoff truth cleanup |
