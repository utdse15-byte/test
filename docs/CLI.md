...
| `manju roundtrip <edited file> [--apply]` | WP6 | flow JianYing skeleton / OTIO / FCPXML edits back as reviewable truth changes (FCPXML so a free DaVinci Resolve edit can return) |
