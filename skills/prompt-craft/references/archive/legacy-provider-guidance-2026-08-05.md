...
DO NOT AUTO-LOAD
DO NOT USE AS CURRENT PROVIDER FACT

This snapshot preserves the provider-specific guidance removed from the core
skill on 2026-08-05. It is audit history only. Current machine capabilities
and limits come from ProviderManifest; unverified prompt semantics remain
unknown until backed by dated official documentation or owner tests.
