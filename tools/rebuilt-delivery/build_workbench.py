...
template=template.replace('<!-- STORY_SECTION -->',(root/'tools/workbench.story.html').read_text(encoding='utf-8'))
template=template.replace('<!-- STORY_RETURN_SECTION -->',(root/'tools/workbench.storyreturn.html').read_text(encoding='utf-8'))
script=script.replace('// STORY_SCRIPT',(root/'tools/workbench.story.core.js').read_text(encoding='utf-8')+'\n'+(root/'tools/workbench.story.js').read_text(encoding='utf-8')+'\n'+(root/'tools/workbench.storydiff.js').read_text(encoding='utf-8')+'\n'+(root/'tools/workbench.storyreturn.core.js').read_text(encoding='utf-8')+'\n'+(root/'tools/workbench.storyreturn.js').read_text(encoding='utf-8'))
...
template=template.replace('/* EXPERIENCE_STYLE */',(root/'tools/workbench.experience.css').read_text(encoding='utf-8')+(root/'tools/workbench.inspection.css').read_text(encoding='utf-8')+(root/'tools/workbench.story.css').read_text(encoding='utf-8')+(root/'tools/workbench.comfort.css').read_text(encoding='utf-8')+(root/'tools/workbench.storydiff.css').read_text(encoding='utf-8')+(root/'tools/workbench.storyreturn.css').read_text(encoding='utf-8'))
