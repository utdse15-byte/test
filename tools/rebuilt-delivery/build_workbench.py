...
template=template.replace('/* EXPERIENCE_STYLE */',(root/'tools/workbench.experience.css').read_text(encoding='utf-8')+(root/'tools/workbench.inspection.css').read_text(encoding='utf-8')+(root/'tools/workbench.story.css').read_text(encoding='utf-8')+(root/'tools/workbench.comfort.css').read_text(encoding='utf-8')+(root/'tools/workbench.storydiff.css').read_text(encoding='utf-8'))
